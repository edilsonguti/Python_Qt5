...
class Janela (QMainWindow):
    def __init__(self):
        ...
        botao1.setStyleSheet('QPushButton {background-color:#0FB328;font:bond; font-size:20px}')
    ...
    def botao1_click(self):
        self.label_1.setText("O carro branco foi selecionado")
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;color:"red"}')
        self.carro.setPixmap(QtGui.QPixmap('carro_bco.jpeg'))
    def botao2_click(self):
        self.label_1.setText("O carro cinza foi selecionado")
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;color:"green"}')
        self.carro.setPixmap(QtGui.QPixmap('carro_cza.jpeg'))
